...
class Project(Model):
    ...
    def get_absolute_url(self):
        return '/team-ideation-tools/stories/projects/%d/' % self.project_id
...
class Scenario(Model):
    ...
    def get_absolute_url(self):
        return '/team-ideation-tools/stories/projects/%d/scenarios/%d/' % (self.project_id, self.pk)

    def get_create_story_url(self):
        return '/team-ideation-tools/stories/projects/%d/scenarios/%d/add-story/' % (self.project_id, self.pk)
...
class Story(Model):
    ...
    def get_absolute_url(self):
        return '/team-ideation-tools/stories/projects/%d/stories/%d/' % (self.project_id, self.pk)
