...
class ConnectionViewTests(TestCase):
    ...
    def test_home_view(self):
        response = self.client.get('/team-ideation-tools/anonymizer/')
        self.assertEqual(response.status_code, 200)

    def test_create_connection(self):
        form_url = '/team-ideation-tools/anonymizer/connection/create/'
    ...
    def test_update_sqlite3_info(self):
        ...
        form_url = '/team-ideation-tools/anonymizer/connection/update-info/1/sqlite3/'
    ...
    def test_update_mysql_info(self):
        ...
        form_url = '/team-ideation-tools/anonymizer/connection/update-info/1/mysql/'
    ...
    def test_update_postgres_info(self):
        ...
        form_url = '/team-ideation-tools/anonymizer/connection/update-info/1/postgres/'
    ...
    def test_select_user_table(self):
        ...
        form_url = '/team-ideation-tools/anonymizer/connection/1/suggest-user-table/'
    ...
    def test_select_properties(self):
        ...
        form_url = '/team-ideation-tools/anonymizer/connection/1/select-columns/'
    ...
    def test_console(self):
        ...
        console_url = '/team-ideation-tools/anonymizer/connection/1/console/'
        query_url = '/team-ideation-tools/anonymizer/connection/1/query/'
    ...
    def test_delete_view(self):
        ...
        form_url = '/team-ideation-tools/anonymizer/connection/1/delete/'
